...
local v127 =
    v126:CreateWindow(
    {
        ["Title"] = "SPEED SCRIPTS HUB | FISCH v1.0",
        ["SubTitle"] = "by japa dev @srvitor222",
        ["TabWidth"] = 588 - 428,
...
v128.Home:AddButton(
    {
        ...
        ["Callback"] = function()
            ...
            while true do
                if (v149 == 0) then
                    v150 = "https://discord.gg/88BsMHmB"
...
v128.Home:AddParagraph(
    {
        ...
        ["Content"] = "SPEED SCRIPTS HUB, the ultimate Roblox exploit hub, now has its very own Discord server! This is your go-to place to stay updated on all the latest features, scripts, and announcements. Here’s what you can do in our server:\nStay Informed:\nGet real-time updates on the latest developments, script releases, and exploit features available in SPEED SCRIPTS HUB.\nScript Requests:\nNeed a specific script? Submit your requests, and our team or community may create one for you.\nExclusive Giveaways:\nParticipate in exciting Robux giveaways exclusively for our Discord members.\nCommunity Interaction:\nConnect with like-minded exploit enthusiasts, share tips, and get help from a supportive community.\nMuch More:\nEnjoy sneak peeks, community events, and future features tailored for SPEED SCRIPTS HUB users."
    }
)
v128.Home:AddParagraph(
    {
        ["Title"] = "Join us",
        ["Content"] = "Join us now and take your Roblox experience to the next level with SPEED SCRIPTS HUB’s dedicated community!"
    }
)
v128.Main:AddButton(
    {
