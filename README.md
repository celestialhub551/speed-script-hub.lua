if getgenv().cuppink then warn("speed script hub : Already executed!") return end
...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .." | speed script hub - free",
    SubTitle = "https://discord.gg/88BsMHmB)",
    TabWidth = 160,
...
do
    Tabs.Home:AddButton({
        ...
        Callback = function()
            setclipboard("https://discord.gg/88BsMHmB")
        end
    })
